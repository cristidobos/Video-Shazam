...
default_images_folder = "../resource/lib/publicdata/Images/joint"
...
if __name__ == '__main__':
    ...
    if feature_active('harris'):
        ...
        with open(fname, 'rb') as f:
            harris_vocabulary = pickle.load(f, encoding="bytes")
    ...
    if feature_active('colorhist'):
        ...
        with open(fname, 'rb') as f:
            colorhist_features = pickle.load(f, encoding="bytes")
    ...
    if feature_active('geo'):
        ...
        with open(fname, 'rb') as f:
            geo_features = pickle.load(f, encoding="bytes")
